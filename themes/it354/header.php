...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$it354_description = get_bloginfo( 'description', 'display' );
			if ( $it354_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $it354_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
